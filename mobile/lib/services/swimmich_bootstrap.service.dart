...
///
/// Non-star albums are prefixed with `_` to sort to the top. Star albums use
/// emoji names (⭐/⭐⭐/⭐⭐⭐). All are identified robustly by their storage
/// key — never rely on name alone. The storage key is the
