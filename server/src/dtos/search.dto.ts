...
import { AssetOrder, AssetOrderSchema, AssetTypeSchema, AssetVisibilitySchema, SortStatusSchema } from 'src/enum';
...
const BaseSearchSchema = z.object({
  ...
  sortStatus: SortStatusSchema.optional().describe('Filter by Swimmich sort status'),
